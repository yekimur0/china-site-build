...
swiper__WEBPACK_IMPORTED_MODULE_2__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_2__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_2__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_2__.Scrollbar, swiper__WEBPACK_IMPORTED_MODULE_2__.Autoplay]);
const SWIPER_TICKER = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.ticker-swiper', {
  slidesPerView: 'auto',
  loop: true,
  spaceBetween: 20,
  autoplay: {
...
const inputMask = new (inputmask__WEBPACK_IMPORTED_MODULE_7___default())('+7 (999) 999-99-99');
tel.forEach(item => {
  inputMask.mask(item);
});
(0,_functions_accordion__WEBPACK_IMPORTED_MODULE_4__.accordion)();
